...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    p.add_argument("--policy-a", default=None, choices=["scoring", "survival", "fixed"], help="MAIN policy for a rule_based agent A")
    p.add_argument("--policy-b", default=None, choices=["scoring", "survival", "fixed"], help="MAIN policy for a rule_based agent B")
